...
export default function VapiWidget({ assistantId, config={}} : VapiWidgetProps) {
  ...
  if (!isLoaded) return null;
    ...
    return <div className="max-w-5xl mx-auto px-4 flex flex-col overflow-hidden pb-20">
      {/* TITLE */}
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold font-mono">
          <span>Talk to Your </span>
          <span className="text-primary uppercase"> Assistant</span>
        </h1>
